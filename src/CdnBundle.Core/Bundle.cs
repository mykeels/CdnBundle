...
namespace CdnBundle.Core
{
    public class Bundle
    {
        ...
        public static string getLocalFilePath(string localUrl)
        {
            ...
            else if (!String.IsNullOrEmpty(localUrlPath)) return localUrlPath.Replace("~", System.IO.Directory.GetCurrentDirectory() System.Environment.CurrentDirectory.Replace(@"\", "/"));
            return localUrlPath ?? "";
        }
